...
void HistGuiLayout()
{
   ...
   // main frame
   TGMainFrame *fHistVarFrame = new TGMainFrame(gClient->GetRoot(),10,10,kMainFrame | kVerticalFrame);
   fHistVarFrame->SetName("fHistVarFrame");
   fHistVarFrame->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame2592 = new TGCompositeFrame(fHistVarFrame,754,487,kVerticalFrame);
   fMainFrame2592->SetName("fMainFrame2592");
   fMainFrame2592->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame2438 = new TGCompositeFrame(fMainFrame2592,749,484,kVerticalFrame);
   fMainFrame2438->SetName("fMainFrame2438");
   fMainFrame2438->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame1180 = new TGCompositeFrame(fMainFrame2438,746,479,kVerticalFrame);
   fMainFrame1180->SetName("fMainFrame1180");
   fMainFrame1180->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame2078 = new TGCompositeFrame(fMainFrame1180,754,492,kVerticalFrame);
   fMainFrame2078->SetName("fMainFrame2078");
   fMainFrame2078->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame4698 = new TGCompositeFrame(fMainFrame2078,787,504,kVerticalFrame);
   fMainFrame4698->SetName("fMainFrame4698");
   fMainFrame4698->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame1001 = new TGCompositeFrame(fMainFrame4698,746,473,kVerticalFrame);
   fMainFrame1001->SetName("fMainFrame1001");
   fMainFrame1001->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame942 = new TGCompositeFrame(fMainFrame1001,744,475,kVerticalFrame);
   fMainFrame942->SetName("fMainFrame942");
   fMainFrame942->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame1678 = new TGCompositeFrame(fMainFrame942,745,477,kVerticalFrame);
   fMainFrame1678->SetName("fMainFrame1678");
   fMainFrame1678->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame909 = new TGCompositeFrame(fMainFrame1678,742,471,kVerticalFrame);
   fMainFrame909->SetName("fMainFrame909");
   fMainFrame909->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame1598 = new TGCompositeFrame(fMainFrame909,743,471,kVerticalFrame);
   fMainFrame1598->SetName("fMainFrame1598");
   fMainFrame1598->SetLayoutBroken(kTRUE);

   // composite frame
   TGCompositeFrame *fMainFrame2824 = new TGCompositeFrame(fMainFrame1598,744,473,kVerticalFrame);
   fMainFrame2824->SetName("fMainFrame2824");
   ...
   TGTextEntry *fCommandEntry = new TGTextEntry(fCompositeFrame717, new TGTextBuffer(14),-1,uGC->GetGC(),ufont->GetFontStruct(),kSunkenFrame | kDoubleBorder | kOwnBackground);
   fCommandEntry->SetMaxLength(4096);
   ...
   TGLabel *fCommandLabel = new TGLabel(fCompositeFrame717,"Command (member function)",uGC->GetGC(),ufont->GetFontStruct());
   fCommandLabel->SetTextJustify(33);
   ...
   TGGroupFrame *fHistCreateFrame = new TGGroupFrame(fCompositeFrame717,"Create New");
   fHistCreateFrame->SetLayoutBroken(kTRUE);

   TGNumberEntryField *fHighX = new TGNumberEntryField(fHistCreateFrame, 0, (Double_t) 0);
   fHistCreateFrame->AddFrame(fHighX, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fHighX->MoveResize(436,103,59,22);
   TGNumberEntryField *fLowX = new TGNumberEntryField(fHistCreateFrame, 1, (Double_t) 0);
   fHistCreateFrame->AddFrame(fLowX, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLowX->MoveResize(372,103,59,22);
   TGNumberEntryField *fBinsX = new TGNumberEntryField(fHistCreateFrame, 2, (Double_t) 0);
   fHistCreateFrame->AddFrame(fBinsX, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fBinsX->MoveResize(308,103,59,22);

   TGNumberEntryField *fBinsY = new TGNumberEntryField(fHistCreateFrame, 3, (Double_t) 0);
   fHistCreateFrame->AddFrame(fBinsY, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fBinsY->MoveResize(308,135,59,22);
   TGNumberEntryField *fLowY = new TGNumberEntryField(fHistCreateFrame, 4, (Double_t) 0);
   fHistCreateFrame->AddFrame(fLowY, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLowY->MoveResize(372,135,59,22);
   TGNumberEntryField *fHighY = new TGNumberEntryField(fHistCreateFrame, 5, (Double_t) 0);
   fHistCreateFrame->AddFrame(fHighY, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fHighY->MoveResize(436,135,59,22);

   TGNumberEntryField *fBinsZ = new TGNumberEntryField(fHistCreateFrame, 6, (Double_t) 0);
   fHistCreateFrame->AddFrame(fBinsZ, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fBinsZ->MoveResize(308,167,59,22);
   TGNumberEntryField *fLowZ = new TGNumberEntryField(fHistCreateFrame, 7, (Double_t) 0);
   fHistCreateFrame->AddFrame(fLowZ, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   fLowZ->MoveResize(372,167,59,22);
   TGNumberEntryField *fHighZ = new TGNumberEntryField(fHistCreateFrame, 8, (Double_t) 0);
   fHistCreateFrame->AddFrame(fHighZ, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   TGLabel *fLabelX = new TGLabel(fHistCreateFrame,"x",uGC->GetGC(),ufont->GetFontStruct());
   fLabelX->SetTextJustify(36);
   ...
   TGLabel *fLabelY = new TGLabel(fHistCreateFrame,"y",uGC->GetGC());
   fLabelY->SetTextJustify(36);
   ...
   TGLabel *fLabelZ = new TGLabel(fHistCreateFrame,"z",uGC->GetGC(),ufont->GetFontStruct());
   fLabelZ->SetTextJustify(36);
   ...
   TGLabel *fLabelParameter = new TGLabel(fHistCreateFrame,"Parameter",uGC->GetGC(),ufont->GetFontStruct());
   fLabelParameter->SetTextJustify(33);
   ...
   TGLabel *fLabelBins = new TGLabel(fHistCreateFrame,"Bins",uGC->GetGC(),ufont->GetFontStruct());
   fLabelBins->SetTextJustify(33);
   ...
   TGLabel *fLabelLow = new TGLabel(fHistCreateFrame,"Low",uGC->GetGC(),ufont->GetFontStruct());
   fLabelLow->SetTextJustify(33);
   ...
   TGLabel *fLabelHigh = new TGLabel(fHistCreateFrame,"High",uGC->GetGC(),ufont->GetFontStruct());
   fLabelHigh->SetTextJustify(33);
   ...
   TGTextEntry *fGateEntry = new TGTextEntry(fHistCreateFrame, new TGTextBuffer(14),-1,uGC->GetGC(),ufont->GetFontStruct(),kSunkenFrame | kDoubleBorder | kOwnBackground);
   fGateEntry->SetMaxLength(4096);
   ...
   TGLabel *fGateLabel = new TGLabel(fHistCreateFrame,"Gate",uGC->GetGC(),ufont->GetFontStruct());
   fGateLabel->SetTextJustify(33);
   ...
   TGTextEntry *fNameEntry = new TGTextEntry(fHistCreateFrame, new TGTextBuffer(14),-1,uGC->GetGC(),ufont->GetFontStruct(),kSunkenFrame | kDoubleBorder | kOwnBackground);
   fNameEntry->SetMaxLength(4096);
   ...
   TGTextEntry *fTitleEntry = new TGTextEntry(fHistCreateFrame, new TGTextBuffer(14),-1,uGC->GetGC(),ufont->GetFontStruct(),kSunkenFrame | kDoubleBorder | kOwnBackground);
   fTitleEntry->SetMaxLength(4096);
   ...
   TGLabel *fTypeLabel = new TGLabel(fHistCreateFrame,"Type",uGC->GetGC(),ufont->GetFontStruct());
   fTypeLabel->SetTextJustify(33);
   ...
   // combo box
   TGComboBox *fParamZ = new TGComboBox(fHistCreateFrame,"",-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   fParamZ->Resize(264,22);
   fParamZ->Select(-1);
   ...
   // combo box
   TGComboBox *fParamY = new TGComboBox(fHistCreateFrame,"",-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   fParamY->Resize(264,22);
   fParamY->Select(-1);
   ...
   // combo box
   TGComboBox *fParamX = new TGComboBox(fHistCreateFrame,"",-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   fParamX->Resize(264,22);
   fParamX->Select(0);
   ...
   // combo box
   TGComboBox *fEventEntry = new TGComboBox(fHistCreateFrame,-1,kHorizontalFrame | kSunkenFrame | kDoubleBorder | kOwnBackground);
   fEventEntry->Resize(256,22);
   ...
   TGLabel *fEventLabel = new TGLabel(fHistCreateFrame,"Event type",uGC->GetGC(),ufont->GetFontStruct());
   fEventLabel->SetTextJustify(33);
   ...
   TGLabel *fNameLabel = new TGLabel(fHistCreateFrame,"Name",uGC->GetGC(),ufont->GetFontStruct());
   fNameLabel->SetTextJustify(33);
   ...
   TGLabel *fTitleLabel = new TGLabel(fHistCreateFrame,"Title",uGC->GetGC(),ufont->GetFontStruct());
   fTitleLabel->SetTextJustify(33);
   ...
   TGGroupFrame *fHistConfigFrame = new TGGroupFrame(fHistCreateFrame,"Configuration File");
   fHistConfigFrame->SetLayoutBroken(kTRUE);
   ...
   TGTextEntry *fDrawOptionEntry = new TGTextEntry(fCompositeFrame717, new TGTextBuffer(14),-1,uGC->GetGC(),ufont->GetFontStruct(),kSunkenFrame | kDoubleBorder | kOwnBackground);
   fDrawOptionEntry->SetMaxLength(4096);
   ...
   TGLabel *fDrawOptionLabel = new TGLabel(fCompositeFrame717,"Draw option:",uGC->GetGC(),ufont->GetFontStruct());
   fDrawOptionLabel->SetTextJustify(17);
   ...
   TGGroupFrame *fVariablesFrame = new TGGroupFrame(fCompositeFrame857,"Variables");
   fVariablesFrame->SetLayoutBroken(kTRUE);
   ...
   TGNumberEntryField *fVarEntry = new TGNumberEntryField(fVariablesFrame, 9, (Double_t) 0);
   fVariablesFrame->AddFrame(fVarEntry, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
   ...
   TGGroupFrame *fConfigAllFrame = new TGGroupFrame(fCompositeFrame857,"Configuration Files");
   fConfigAllFrame->SetLayoutBroken(kTRUE);
   ...
   TGGroupFrame *fConfigLoadMethodFrame = new TGGroupFrame(fConfigAllFrame,"Load Method");
   fConfigLoadMethodFrame->SetLayoutBroken(kTRUE);
   TGRadioButton *fConfigLoadMethodReset = new TGRadioButton(fConfigLoadMethodFrame,"Reset");
   fConfigLoadMethodReset->SetTextJustify(36);
   ...
   TGRadioButton *fConfigLoadMethodOverwrite = new TGRadioButton(fConfigLoadMethodFrame,"Overwrite");
   fConfigLoadMethodOverwrite->SetTextJustify(36);
   ...
   TGRadioButton *fConfigLoadMethodCumulate = new TGRadioButton(fConfigLoadMethodFrame,"Cumulate");
   fConfigLoadMethodCumulate->SetTextJustify(36);
   ...
   fHistVarFrame->AddFrame(fMainFrame2592, new TGLayoutHints(kLHintsExpandX | kLHintsExpandY));
   fMainFrame2592->MoveResize(0,0,754,487);

   fHistVarFrame->SetMWMHints(kMWMDecorAll,
                        kMWMFuncAll,
                        kMWMInputModeless);
   fHistVarFrame->MapSubwindows();

   fHistVarFrame->Resize(fHistVarFrame->GetDefaultSize());
   fHistVarFrame->MapWindow();
   fHistVarFrame->Resize(741,471);
