...
Double_t GetMaximum(Double_t maxval = 3.4e+38f) const
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
...
Double_t GetMinimum(Double_t minval = -3.4e+38f) const
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
...
void SetLabelOffset(Float_t offset = 5e-3, Option_t* axis = "X")
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
...
void SetLabelSize(Float_t size = 2e-2, Option_t* axis = "X")
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
...
void SetTickLength(Float_t length = 2e-2, Option_t* axis = "X")
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
...
void SetTitleSize(Float_t size = 2e-2, Option_t* axis = "X")
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
...
Int_t ShowPeaks(Double_t sigma = 2, Option_t* option = "", Double_t threshold = 5e-2)
{
  rb::ScopedLock<rb::Mutex> LOCK (TTHREAD_GLOBAL_MUTEX);
