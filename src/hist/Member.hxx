...
#define UNDEF_MAX_MEMBER_FN_ARGUMENTS
#endif
...
{
  template <class TT> R operator() (TT& t) HIST_MEMBER_CONST {
    return boost::bind(fFun, &t)();
  }
  NAME(R (T::* fun)() HIST_MEMBER_CONST) :
    fFun(fun) {}
private:
  R (T::* fFun)() HIST_MEMBER_CONST;
};
template <class R, class TT, class T>
inline R FNAME(TT& object, R(T::* function)() HIST_MEMBER_CONST) {
...
struct NAME : public rb::visit::Locked<R>
{
  ...
  NAME(R (T::* fun)(A1) HIST_MEMBER_CONST, A1 a1) :
    fFun(fun), fA1(a1) {}
private:
  A1 fA1;
  R (T::* fFun)(A1) HIST_MEMBER_CONST;
};
template <class R, class TT, class T, class A1>
inline R FNAME(TT& object, R(T::* function)(A1) HIST_MEMBER_CONST, A1 a1) {
...
#ifdef UNDEF_MAX_MEMBER_FN_ARGUMENTS
#undef UNDEF_MAX_MEMBER_FN_ARGUMENTS
...
#ifdef HIST_MEMBER_CONST
#undef HIST_MEMBER_CONST
#endif
