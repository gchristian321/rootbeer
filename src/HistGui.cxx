...
//	 fParamX->Associate(this);
	...
	gClient->GetColorByName("#0000ff",ucolor);
	/* TGTextButton* */ fHistSaveButton = new TGTextButton(fHistConfigFrame,"Save Histograms",-1,uGC->GetGC());
	...
	fHistSaveButton->MoveResize(17-7,25,106,24);
	...
	gClient->GetColorByName("#ffcc00",ucolor);
	/* TGTextButton* */ fHistLoadButton = new TGTextButton(fHistConfigFrame,"Load Histograms",-1,uGC->GetGC());
	...
	fHistLoadButton->MoveResize(17-7,63,106,24);
	...
	Int_t loadY = 100, yDiff = 28;
	// HIST
	gClient->GetColorByName("#ffcc00",ucolor);
	/* TGTextButton* */ fConfigHistLoadButton = new TGTextButton(fConfigAllFrame,"Load Histograms");
	fConfigHistLoadButton->SetFont(ufont->GetFontStruct());
	fConfigHistLoadButton->SetTextJustify(36);
	fConfigHistLoadButton->SetMargins(0,0,0,0);
	fConfigHistLoadButton->SetWrapLength(-1);
	fConfigHistLoadButton->Resize(105,24);

	fConfigHistLoadButton->ChangeBackground(ucolor);
	fConfigAllFrame->AddFrame(fConfigHistLoadButton, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
	fConfigHistLoadButton->MoveResize(136,loadY,105,24); loadY += yDiff;

	// CANVAS
	gClient->GetColorByName("#ffcc00",ucolor);
	/* TGTextButton* */ fConfigCanvasLoadButton = new TGTextButton(fConfigAllFrame,"Load Canvas");
	fConfigCanvasLoadButton->SetFont(ufont->GetFontStruct());
	fConfigCanvasLoadButton->SetTextJustify(36);
	fConfigCanvasLoadButton->SetMargins(0,0,0,0);
	fConfigCanvasLoadButton->SetWrapLength(-1);
	fConfigCanvasLoadButton->Resize(105,24);

	fConfigCanvasLoadButton->ChangeBackground(ucolor);
	fConfigAllFrame->AddFrame(fConfigCanvasLoadButton, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
	fConfigCanvasLoadButton->MoveResize(136,loadY,105,24); loadY += yDiff;

	// VARIABLE
	gClient->GetColorByName("#ffcc00",ucolor);
	/* TGTextButton* */ fConfigVariableLoadButton = new TGTextButton(fConfigAllFrame,"Load Variables");
	fConfigVariableLoadButton->SetFont(ufont->GetFontStruct());
	fConfigVariableLoadButton->SetTextJustify(36);
	fConfigVariableLoadButton->SetMargins(0,0,0,0);
	fConfigVariableLoadButton->SetWrapLength(-1);
	fConfigVariableLoadButton->Resize(105,24);

	fConfigVariableLoadButton->ChangeBackground(ucolor);
	fConfigAllFrame->AddFrame(fConfigVariableLoadButton, new TGLayoutHints(kLHintsLeft | kLHintsTop,2,2,2,2));
	fConfigVariableLoadButton->MoveResize(136,loadY,105,24); loadY += yDiff;

	// ALL
	gClient->GetColorByName("#00ff00",ucolor);
	/* TGTextButton* */ fConfigAllLoadButton = new TGTextButton(fConfigAllFrame,"Load All");
	...
	fConfigAllLoadButton->MoveResize(136,loadY,105,24); loadY += yDiff;
	...
	fConfigAllFrame->MoveResize(377,8,256,224);
...
// ===== Variables/Config ===== //
  ...
  fConfigAllSaveButton->Connect("Pressed()", "TGTextButton",    fConfigAllSaveButton, "SetDown(=false)");
	...
	fHistLoadButton->Connect("Pressed()", "rb::HistSignals",      RB_HIST_SIGNALS, "ReadHistConfig(=true)");
	...
	fConfigHistLoadButton->Connect("Pressed()", "rb::HistSignals", RB_HIST_SIGNALS, "ReadHistConfig(=false)");
	fConfigHistLoadButton->Connect("Pressed()", "TGTextButton",    fConfigHistLoadButton, "SetDown(=false)");
	fConfigCanvasLoadButton->Connect("Pressed()", "rb::HistSignals", RB_HIST_SIGNALS, "ReadCanvasConfig()");
	fConfigCanvasLoadButton->Connect("Pressed()", "TGTextButton",    fConfigCanvasLoadButton, "SetDown(=false)");
	fConfigVariableLoadButton->Connect("Pressed()", "rb::HistSignals", RB_HIST_SIGNALS, "ReadVariablesConfig()");
	fConfigVariableLoadButton->Connect("Pressed()", "TGTextButton",    fConfigVariableLoadButton, "SetDown(=false)");

	fVariablesTree->Connect("DoubleClicked(TGListTreeItem*, Int_t)", "rb::HistSignals",
													RB_HIST_SIGNALS, "ReadVariable(TGListTreeItem*, Int_t)");
