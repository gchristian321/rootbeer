/// \file mxml.hxx
/// \brief Header file for mxml.cxx
...
/********************************************************************\
   ...
   $Id: mxml.h 71 2012-02-03 12:57:34Z ritt $
...
/*
	...
	are as follows:
	 - Extension changed to .hxx (intended for C++ compilation).
...
static const int  MXML_NAME_LENGTH = 64;

static const int  ELEMENT_NODE                  = 1;
static const int  TEXT_NODE                     = 2;
static const int  PROCESSING_INSTRUCTION_NODE   = 3;
static const int  COMMENT_NODE                  = 4;
static const int  DOCUMENT_NODE                 = 5;

static const int  INTERNAL_ENTITY               = 0;
static const int  EXTERNAL_ENTITY               = 1;
static const int  MXML_MAX_ENTITY             = 500;

static const int  MXML_MAX_CONDITION           = 10;
}

#ifdef _MSC_VER
#define MXML_DIR_SEPARATOR              '\\'
#else
#define MXML_DIR_SEPARATOR               '/'
#endif
