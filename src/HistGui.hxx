...
protected:
	...
	TGTextButton *fConfigHistLoadButton; // "Load Histograms"
	TGTextButton *fConfigVariableLoadButton; // "Load Canvases"
	TGTextButton *fConfigCanvasLoadButton; // "Load Variables"
	TGTextButton *fConfigAllLoadButton; // "Load All"
