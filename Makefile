...
$(OBJ)/Hist.o: $(CINT)/RBDictionary.cxx $(SRC)/hist/Hist.cxx
	$(COMPILE) $(FPIC) -c \
-o $@  -p $(SRC)/hist/Hist.cxx \

$(OBJ)/Manager.o: $(CINT)/RBDictionary.cxx $(SRC)/hist/Manager.cxx
	$(COMPILE) $(FPIC) -c \
...
# $(SRC)/hist/Manager.hxx
# HIST_OBJECTS=$(OBJ)/Hist.o $(OBJ)/Formula.o $(OBJ)/Manager.o
